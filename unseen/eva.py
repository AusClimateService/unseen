...
def fit_gev(
    ...
    - The `retry_fit` may be deprecated in future versions as `use_basinhopping`
    may be a better method to improve the fit.
    ...
    def _fit_1d(
        ...
        if stationary or pick_best_model:
            ...
            if retry_fit:
                # Retry fit using alternative fitstart method
                _kwargs = kwargs.copy()
                ...
                nll_1 = _gev_nllf(dparams, data)
                nll_2 = _gev_nllf(dparams_alt, data)
                if nll_2 < nll_1:
                    dparams = dparams_alt
