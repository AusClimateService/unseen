...
IO_OPTIONS=--variables ${VAR} --region ${SHAPEFILE} --shp_header ${SHP_HEADER} --spatial_agg ${SPATIAL_AGG} --no_leap_days --time_freq ${TIME_FREQ} --time_agg ${TIME_AGG} --units ${UNITS}
